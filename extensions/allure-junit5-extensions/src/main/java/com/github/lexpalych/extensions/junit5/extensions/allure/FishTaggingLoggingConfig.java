package com.github.lexpalych.extensions.junit5.extensions.allure;
...
public class FishTaggingLoggingConfig extends ConfigurationFactory {
    ...
    static Configuration createConfiguration(final String name, ConfigurationBuilder<BuiltConfiguration> builder) {
        ...
        LoggerComponentBuilder restAssured = builder
                .newLogger("com.github.lexpalych.extensions.junit5.extensions.allure.LoggerStreamProvider")
                .add(builder.newAppenderRef("fileAppender"));

        LoggerComponentBuilder stepWrapper = builder
                .newLogger("com.github.lexpalych.extensions.junit5.allure.steps")
                .add(builder.newAppenderRef("fileAppender"));

        LoggerComponentBuilder api = builder
                .newLogger("com.github.lexpalych.extensions.allure.rest.assured")
                .add(builder.newAppenderRef("fileAppender"));

        LoggerComponentBuilder webDriver = builder
                .newLogger("com.github.lexpalych.extensions.allure.webdriver")
                .add(builder.newAppenderRef("fileAppender"));
